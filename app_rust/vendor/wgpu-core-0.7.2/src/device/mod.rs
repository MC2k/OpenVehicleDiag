...
impl<B: GfxBackend> Device<B> {
    ...
    fn create_texture_view(
        ...
        let view_dim =
            match desc.dimension {
                ...
                None => match texture.kind {
                    hal::image::Kind::D1(..) => TextureViewDimension::D1,
                    hal::image::Kind::D2(_, _, depth, _)
                        if depth > 1 && desc.array_layer_count.is_none() =>
                    {
                        TextureViewDimension::D2Array
                    }
                    hal::image::Kind::D2(..) => TextureViewDimension::D2,
                    hal::image::Kind::D3(..) => TextureViewDimension::D3,
                },
            };
        ...
        let layer_check_ok = match view_dim {
            ...
            | TextureViewDimension::D3 => view_layer_count == 1,
            TextureViewDimension::D2Array => true,
            TextureViewDimension::Cube => view_layer_count == 6,
            TextureViewDimension::CubeArray => view_layer_count % 6 == 0,
        };
        if !layer_check_ok {
...
impl<G: GlobalIdentityHandlerFactory> Global<G> {
    ...
    pub fn device_create_bind_group_layout<B: GfxBackend>(
        ...
        let error = 'outer: loop {
            ...
            if size_of::<Input<G, id::BindGroupLayoutId>>() == 0 {
